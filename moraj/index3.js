...
function escolhas(numero) {
    if (numero == 1) {
      window.location.assign("./p3fase2opcao1.html");
    } else if (numero == 2) {
      window.location.assign("./p3fase2opcao2.html");
    }
  };
  ...
  function escolhas2(numero) {
    if (numero == 1) {
      window.location.assign("./p3fase3opcao11.html");
    } else if (numero == 2) {
      window.location.assign("./p3fase3opcao12.html");
    }
  };
  ...
  function escolhas22(numero) {
    if (numero == 1) {
      window.location.assign("./p3fase3opcao21.html");
    } else if (numero == 2) {
      window.location.assign("./p3fase3opcao22.html");
    }
  };
  ...
  //funções da terceira fase. existem duas opções para que a vitória não esteja sempre no número 1
