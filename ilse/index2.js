...
function escolhas(numero) {
    if (numero == 1) {
      window.location.assign("./p2fase2opcao1.html");
    } else if (numero == 2) {
      window.location.assign("./p2fase2opcao2.html");
    }
  };
  ...
  function escolhas2(numero) {
    if (numero == 1) {
      window.location.assign("./p2fase3opcao11.html");
    } else if (numero == 2) {
      window.location.assign("./p2fase3opcao12.html");
    }
  };
  ...
  function escolhas22(numero) {
    if (numero == 1) {
      window.location.assign("./p2fase3opcao21.html");
    } else if (numero == 2) {
      window.location.assign("./p2fase3opcao22.html");
    }
  };
